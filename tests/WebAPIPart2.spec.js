...
//IN this test we have opened the website, logged in and stored the session cookie in beforehook and used the same to
// simulate the page to be already logged in when opening new browser context
